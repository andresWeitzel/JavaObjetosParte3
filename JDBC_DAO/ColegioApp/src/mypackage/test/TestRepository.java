...
public class TestRepository {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n--Borramos el campo con el id que le pasem como parametro---");
        cursoRepository.remove(cursoRepository.getById(1));

        System.out.println("\n---Todos los campos de nuestra tabla curso--");
        ...
        System.out.println("\n---Actualizamos el campo que tenga el i pasado-- - ");
        curso = cursoRepository.getById(10);
